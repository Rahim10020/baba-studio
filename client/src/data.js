...
export const siteConfig = {
  ...
  social: {
    github: "https://github.com/babastudio",
...
export const projects = [
  {
    ...
    year: "2025",
    tools: ["Next.js", "Stripe", "Klaviyo", "Make.com"],
    image: signieImg,
    link: "#",
    featured: true,
    status: "Système Actif",
    role: "Architecture & Développement",
    team: "BabaStudio",
    platform: "Web + Automatisation",
    tldr: {
  ...
  
  {
    ...
    year: "2025",
    tools: ["React Native", "Firebase", "Stripe", "OneSignal"],
    image: notriskImg,
    link: "#",
    featured: true,
    status: "Déployée sur iOS & Android",
  ...
  
  {
    ...
    year: "2024",
    tools: ["Next.js", "PostgreSQL", "Stripe Connect", "Twilio"],
    image: evincoImg,
    link: "#",
    featured: true,
    status: "SaaS Actif - 100+ clients",
    role: "Architecture & Développement",
    team: "BabaStudio",
  ...
  
  {
    ...
    year: "2024",
    tools: ["Next.js", "Stripe", "ConvertKit", "WebinarJam"],
    image: extractImg,
    link: "#",
    featured: true,
    status: "Tunnel Actif - 10K+ ventes",
    role: "Architecture Technique",
    team: "BabaStudio",
    platform: "Web + Email Automation",
    tldr: {
  ...
  
  {
    ...
    year: "2025",
    tools: ["Next.js", "Tailwind", "Calendly", "HubSpot"],
    image: circuitsImg,
    link: "#",
    featured: true,
    status: "Site Actif",
    role: "Strategy & Développement",
    team: "BabaStudio",
    platform: "Web",
    tldr: {
