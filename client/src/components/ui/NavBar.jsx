    ...
    <>
      ...
      >
        ...
        <nav className="hidden md:flex space-x-7 font-grotesk text-body-3 items-center">
          ...
          {/* WhatsApp CTA Button */}
          <a
            href={`${siteConfig.whatsapp}?text=${encodeURIComponent("Bonjour, je veux un audit gratuit")}`}
            target="_blank"
            rel="noopener noreferrer"
            className="group relative px-5 py-2.5 bg-[#25D366] text-white rounded-full hover:bg-[#20BA5A] transition-all duration-300 hover:scale-105 flex items-center gap-2 min-h-[44px]"
          >
      ...
      >
        <nav className="flex flex-col items-center justify-center h-full gap-8 font-grotesk">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={handleLinkClick}
            className={`mt-4 px-8 py-4 bg-[#25D366] text-white rounded-full text-xl font-medium transition-all duration-300 min-h-[44px] flex items-center gap-3 justify-center ${
              isMenuOpen ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
            }`}
          ...
          <Link 
            to="/#contact" 
            onClick={handleLinkClick}
            className={`px-8 py-4 bg-secondary-400 text-accent-400 rounded-full text-xl font-medium transition-all duration-300 min-h-[44px] flex items-center justify-center ${
              isMenuOpen ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
            }`}
